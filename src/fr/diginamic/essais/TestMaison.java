...
public class TestMaison {
    public static void main(String[] args){
        ...
        System.out.printf("Dans la maison nous avons une superficie totale de \u001b[32m%f\u001b[0m m²" +
                ...
                maison.getSuperficieTotale(),
                maison.getSuperficieTotale((byte) 1));
        System.out.printf("Dans toute la maison sont compris \u001b[32m%f\u001b[0m m²" +
                        " par les \u001b[32m%d\u001b[0m chambres.\n",
                maison.getSuperficieTotale(PieceType.CHAMBRE),
                maison.getNombreDePieces(PieceType.CHAMBRE));
    }
}
